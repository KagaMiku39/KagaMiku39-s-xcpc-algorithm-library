...
void solve() {
    ...
    cmin(ans, distancePS(Point(eps, eps), Line(a - c, a - c + length(d - c) * (normalize(b - a) - normalize(d - c)))));

    cmin(ans, distancePS(d, Line(a + length(d - c) * normalize(b - a), b)));
